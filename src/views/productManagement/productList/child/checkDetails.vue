  ...
  >
    <el-form status-icon label-width="100px" class="el-form">
      <div class="basicinformation">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="产品线：" prop="lineName">
              <span>{{ form.lineName }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="产品型号：" prop="modeName" class="left:300px;">
              <span>{{ form.modeName }}</span>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="产品图片：" prop="image">
              <img style="height:30px;" :src="url+form.image" alt />
            </el-form-item>
          </el-col>
          <el-col :span="10">
